        ...
        <HomeLayout>
            <div className="min-h-[90vh] flex items-center justify-center text-white ">
                <div className="w-80 h-[26rem] flex flex-col justify-center items-center shadow-[0_0_10px_black] rounded-lg relative">
                    ...
                    <Link to="/checkout" className="bg-red-500 hover:bg-red-600 text-center transition-all ease-in-out duration-300 absolute bottom-0 w-full py-2 text-xl font-bold rounded-br-lg rounded-bl-lg">
